...
def roms_dataset(ds, Vtransform=None, add_verts=False, proj=None):
    ...
    #     ds.coords['z_w'] = z_w.transpose('time', 's_w', 'eta_rho', 'xi_rho', transpose_coords=False)
    ...
    #     ds.coords['z_rho'] = z_rho.transpose('time', 's_rho', 'eta_rho', 'xi_rho', transpose_coords=False)
    ...
    #     ds['temp'].attrs['coordinates'] = 'lon_rho lat_rho z_rho time'
...
def open_zarr(
    ...
    xrconcatargsin = {"dim": "time", "data_vars": "minimal", "coords": "minimal"}
    # use input xarray arguments and prioritize them over xroms defaults.
