...
def output(to="netcdf"):
    ...
    out1["time"] = ts[:2]
    out1["u"] = (("time", "s_rho", "eta_u", "xi_u"), u[:2])
    out1["v"] = (("time", "s_rho", "eta_v", "xi_v"), v[:2])
    out1["zeta"] = (("time", "eta_rho", "xi_rho"), zeta[:2])
    out1["salt"] = (("time", "s_rho", "eta_rho", "xi_rho"), salt[:2])
    out1["temp"] = (("time", "s_rho", "eta_rho", "xi_rho"), temp[:2])
    ...
    out2["time"] = ts[2:]
    out2["u"] = (("time", "s_rho", "eta_u", "xi_u"), u[2:])
    out2["v"] = (("time", "s_rho", "eta_v", "xi_v"), v[2:])
    out2["zeta"] = (("time", "eta_rho", "xi_rho"), zeta[2:])
    out2["salt"] = (("time", "s_rho", "eta_rho", "xi_rho"), salt[2:])
    out2["temp"] = (("time", "s_rho", "eta_rho", "xi_rho"), temp[2:])
